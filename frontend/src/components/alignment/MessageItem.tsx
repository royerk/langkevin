    ...
    <div className="border border-gray-200 rounded-lg overflow-hidden">
      <div className="flex items-center justify-between bg-gray-50 px-3 py-2">
        <select
          ...
          className="bg-white text-gray-700 text-sm rounded px-2 py-1 border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500"
        >
          {ROLES.map((role) => (
      ...
      <textarea
        ...
        className="w-full bg-white text-gray-900 text-sm p-3 min-h-[100px] resize-y focus:outline-none placeholder:text-gray-400 border-t border-gray-200"
        rows={4}
      />
    </div>
  );
